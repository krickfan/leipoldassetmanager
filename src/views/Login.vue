                      ...
                      <div class="card-body">
                        ...
                        <form>
                          <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter your email" aria-describedby="emailHelp" v-model="username" required>
                          </div>
                          <div class="mb-4">
                            ...
                            <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Enter your password" v-model="password" required>
                          </div>
                          ...
                          <a class="btn btn-dark w-100 py-8 mb-4 rounded-1" @click="handleLogin()">Sign In</a>
...
function handleLogin() : void {
  UserHandler.setCurrentUser({firstname : "Hanna", lastname : "Schmidt", picture : "dummy"});
